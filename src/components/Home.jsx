  ...
  return (
    <div>
      ...
      <div className="d-flex flex-wrap mt-3 justify-content-center gap-4">
        ...
        <div className="d-flex flex-wrap mt-2 justify-content-center gap-4">
          {res_arr.map((item) => {
            return (
              <div className=" border border-dark mb-5 m-1 mx-2">
                <img
                  style={{ width: "350px", height: "248px" }}
                  src={item.image}
                  alt=""
                />
                <div className="bg text-center p-5">
                  ...
                  <button
                    ...
                    className="btn btn-dark float-end m-2 "
                  >
                    delete
                  </button>
                </div>
